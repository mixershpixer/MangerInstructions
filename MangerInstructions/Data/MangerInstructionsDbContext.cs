...
{
    public class MangerInstructionsDbContext : DbContext
    {
        ...
        public MangerInstructionsDbContext(DbContextOptions<MangerInstructionsDbContext> options, IConfiguration configuration)
            : base(options)
        {
